...
describe('swap', () => {
    ...
    it('should successful swap 5 wei to 3 weenus', async () => {
...
`
    ...
    it('should throw insufficient funds error when has not enough tokens to swap', async () => {
    ...
    it('should throw insufficient funds error when has enough tokens to swap but not enough ETH to pay fee', async () => {
        const fromToken = TEST_TOKENS.WEENUS;
        const toToken = TEST_TOKENS.ETH;
